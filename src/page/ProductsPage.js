...
const ProductsPage = () => {
  ...
  if (location.pathname.includes('/watches')) return "Watches";
  if (location.pathname.includes('/musk')) return "Musk Products";
  if (location.pathname.includes('/refresheners')) return "Air and Car Refresheners";
  if (location.pathname.includes('/body-mist')) return "Body Mist & Deodorant";
  if (location.pathname.includes('/body-cream')) return "Body Cream";
  return "All Perfumes";
}, [location.pathname]);
...
case "Body Mist & Deodorant":
      return "Refreshing body mists and deodorants for long-lasting freshness.";
    case "Body Cream":
      return "Moisturizing and nourishing body creams—premium skincare from Platinum.";
    default:
...
const routeFilters = useMemo(() => {
  if (location.pathname.includes('/perfumes/men')) {
    ...
    return { type: ['air', 'furniture','incense','car'] };
